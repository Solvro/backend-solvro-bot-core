...
const command: StaticCommand = new StaticCommand(
  ...
  async (interaction: ChatInputCommandInteraction) => {
    ...
    try {
      ...
      const imageBuffer = googleCalendarService.generateCalendarImage(startDate, officeEvents, {
      ...
      const attachment = new AttachmentBuilder(imageBuffer, { name: 'office-availability.png' })
